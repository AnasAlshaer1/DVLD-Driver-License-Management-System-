...
📂 Project Structure
DVLD/ │ ├── 📁 Forms/ # Windows Forms UI files (Login, Licenses, Tests, etc.) ├── 📁 Classes/ # Business logic and data models ├── 📁 Data/ # JSON and CSV files (if used) ├── 📁 SQL/ # SQL database scripts and backups ├── 📁 Assets/ # Icons and images ├── Program.cs └── README.md
